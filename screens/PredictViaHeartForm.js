    ...
    <SafeAreaView className="bg-white flex-1">
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          >
            <View style={{ flexDirection: "row" }}>
              ...
              <Text style={{ fontSize: 12, fontWeight: "300", marginLeft: 10 }}>
        ...
        {predictedResult == false ? (
          ...
          >
            <Text style={{ fontSize: 20, fontWeight: "300", textAlign: "center" ,paddingHorizontal:30}}>
              Dear {storedData?.userName},there are no signs of any heart disease.
            </Text>
          </View>
        ) : (
          <View
          ...
          >
            <Text style={{ fontSize: 20, fontWeight: "600", textAlign: "center" ,paddingHorizontal:30,color:'red'}}>
